...
The toolkit provides a standard set of spatial units for aggregation, but can accept any user-supplied polygons. Aggregation along the theme dimension follows the causal network, which is supplied by the toolkit for included tools, though the user can specify other causal relationships if required.
