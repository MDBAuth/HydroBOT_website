...
I pair them up in `pull_gauges_to_scale.qmd`, but that then gets lost by the time they're here. Can we go back over there and keep it?
...
No, still there. So, what to do? I think either throw out the gauge, or throw out one set of values.
