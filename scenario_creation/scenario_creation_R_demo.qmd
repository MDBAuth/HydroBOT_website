...
```{r}
scenariodir <- 'scenario_example'
hydrodir <- file.path(scenariodir, 'hydrographs')
...
```{r}
if (REBUILD_DATA) {
      readr::write_csv(base, file.path(hydrodir, 'base', 'base.csv'))
  
      readr::write_csv(up4, file.path(hydrodir, 'up4', 'up4.csv'))
      readr::write_csv(down4, file.path(hydrodir, 'down4', 'down4.csv'))
}
