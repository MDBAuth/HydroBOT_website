...
Although the EWRs define hydrologic thresholds, and the EWR tool assesses only those hydrologic thresholds, they were developed based on hypothesized relationships to ecological objectives and management targets, with those links established in the LTWPs. The causal networks provided by HydroBOT for the EWR tool (`causal_ewr`) have extracted these links from the LTWPs, allowing HydroBOT to connect the outcomes of the EWR module to larger 'theme' scale outcomes.
...
-   `frequency_achieved`- did the `event_years` meet target frequencies?

-   `interevent_achieved`- was the interevent period below or equal to the maximum interevent period?

-   `ewr_achieved`- were both the frequency and interevent conditions met?
