...
**In use, the toolkit expects that scenario hydrographs are available and the causal networks are defined.**

## Development

See the [repo readme](https://github.com/MDBAuth/WERP_toolkit_demo) for additional dev info and more complex package installation issues. See the [{HydroBOT} repo](https://github.com/MDBAuth/WERP_toolkit) repo for development of the package itself.
