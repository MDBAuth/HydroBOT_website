...
See the [repo readme](https://github.com/MDBAuth/HydroBOT) for additional dev info and more complex package installation issues. See the [{HydroBOT} repo](https://github.com/galenholt/HydroBOT) repo for development of the package itself.
