...
The [{HydroBOT}](https://github.com/MDBAuth/WERP_toolkit){style="font-size: 11pt;"} package provides a standard set of spatial data, generated in `data_creation/spatial_data_creation.qmd`. Here, we make quick plots of the data so we know what it looks like.
