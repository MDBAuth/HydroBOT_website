...
Finally, `HydroBOT::param_runner()` ingests paths to these files (or passed command line or lists), turns their params into R arguments, and runs the toolkit.
