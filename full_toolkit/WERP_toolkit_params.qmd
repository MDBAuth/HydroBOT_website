...
Use the `scenario_example/` directory [created](../scenario_creation/scenario_creation_demo_R.qmd) to capture a very simple demonstration case of 46 gauges in three catchments for 10 years.
