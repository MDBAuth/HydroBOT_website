...
Here, we look specifically at how time-aggregation works at a single step, for its use in a sequence of aggregations along other dimensions, see [multi_aggregate](theme_space_agg.qmd) and [read_and_agg](read_and_agg.qmd).
