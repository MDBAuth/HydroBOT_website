---
title: "Grouping and function syntax"
author: "Galen Holt"
format:
  html:
    df-print: paged
...
We can pass single bare aggregation function names, characters, or named lists defining functions with arguments (though this is fragile). Above, we have been specifying the function to apply as just a single bare function name. Now, we explore some other possibilities and capabilities of the aggregator.
