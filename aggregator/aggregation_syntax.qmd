...
First, create test data as in the [spatial notebook](spatial_agg.qmd). This does some simple pre-aggregation in time and theme dimensions to yield something easier to visualise.
