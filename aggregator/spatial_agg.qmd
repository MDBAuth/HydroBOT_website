...
There are many built-in plotting options in HydroBOT, which we will use shortly. First, though a quick ggplot to see what those standardised plot functions start with.
...
#| message: false
#| warning: false
multispatextra <- multi_aggregate(
  dat = simpleclean,
  causal_edges = themeedges,
  groupers = c(
    "scenario", "env_obj",
