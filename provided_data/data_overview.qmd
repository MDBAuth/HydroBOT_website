...
Some spatial units and networks are needed for spatial and theme-dimension aggregation. Users can supply their own, but HydroBOT includes a set of [spatial data](spatial_data.qmd) and [causal networks](causal_overview.qmd) relevant to the Murray-Darling Basin and EWRs.
