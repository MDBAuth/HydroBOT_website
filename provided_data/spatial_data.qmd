...
The [{HydroBOT}](https://github.com/galenholt/HydroBOT){style="font-size: 11pt;"} package provides a standard set of spatial data commonly needed for analyses in the Murray-Darling Basin. Here, we provide visualisation of these datasets.
