...
This document mostly generates that second set, though we will also use it to copy the HydroBOT set over for ease of calling.

```{r}
if (!dir.exists('hydrobot_scenarios')) {
  dir.create('hydrobot_scenarios')
}
file.copy(system.file('extdata/testsmall', package = 'HydroBOT'),
          'hydrobot_scenarios', recursive = TRUE)
file.copy(system.file('extdata/ncdfexample', package = 'HydroBOT'),
          'hydrobot_scenarios', recursive = TRUE)
```
