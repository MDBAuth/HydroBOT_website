...
HydroBOT provides various functions for [creation and manipulation](causal_manipulation.qmd) of causal networks, depending on what needs to be plotted or investigated, and the [causal plots](causal_plots.qmd) page provides some examples of various ways they can be visualised with HydroBOT.
