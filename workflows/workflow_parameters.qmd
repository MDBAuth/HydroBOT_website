...
editor: visual
# params:
#   ewr: !r list(output_parent_dir = 'hydrobot_scenarios/testsmall')
# 
...
run_hydrobot_params(list_args = list(
                      ewr = list(
                        output_parent_dir = 'hydrobot_scenarios/testsmall/hydrographs/base',
                        hydro_dir = 'hydrobot_scenarios/testsmall/hydrographs/base'
                      ),
                      aggregation = list(
...
```{r}
#| eval: false
run_hydrobot_params(yamlpath = 'hydrobot_scenarios/testsmall/aggregator_output/agg_metadata.yml')
```
