...
The workflows section here provides three examples. Similar but not identical examples are available in the [template repository](https://github.com/MDBAuth/toolkit_use), which contains helper scripts for setup on several specific systems as well as skeleton scripts for various workflows. If needed (e.g. Azure at MDBA, HPC systems), contact authors.
