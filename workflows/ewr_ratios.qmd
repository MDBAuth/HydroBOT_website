...
#| fig-cap: Ratio of achievement of each node in the causal network in the 'down4' scenario compared to the 'base' scenario. Color ramp as in map plot @fig-map-relative. White is no change, orange are declines, and blues are increases. 
...
#| fig-cap: Ratio of achievement of each node in the causal network in the 'up4' scenario compared to the 'base' scenario. Color ramp as in map plot @fig-map-relative. White is no change, orange are declines, and blues are increases.
#| 
