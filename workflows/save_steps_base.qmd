...
Run the aggregation. Use the `auto_ewr_PU` shortcut to auto-specify some needed grouping for EWR outputs (see [here](/aggregator/pseudo_spatial_group_until.qmd) for more detail).
