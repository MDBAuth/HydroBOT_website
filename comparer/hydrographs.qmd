...
Briefly, the `read_hydro()` function can also read `.nc` files, but is a bit more constrained as to their format. As a quick demonstration with the data provided with HydroBOT, we can read them in and plot.
