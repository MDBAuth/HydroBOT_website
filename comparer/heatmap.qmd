...
The main thing to remember when making heatmaps is to use `plot_type = 'heatmap'`, and include `x_col`, `y_col` and `outcome_col` (the outcome plotted as colour) arguments.
