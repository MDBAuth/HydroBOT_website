...
There are [many other causal network plots](../provided_data/causal_plots.qmd) we can make but those in the [theme aggregation example](../aggregator/theme_agg.qmd), target outcomes, rather than adjusting other aesthetics of the network for other reasons, such as altering color by level.
