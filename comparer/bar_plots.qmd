...
If we have multiple levels of groupings, we can colour by the groups directly if we don't care what the individual `env_obj`s are doing between them. This is very similar to the plots colouring by SDL unit above.
