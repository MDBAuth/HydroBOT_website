...
For the same set as the function-ed stacks above (and the same as the colcol stack above, but without the grouping. this is similar to above, but now we don't give different palettes to the groups.
