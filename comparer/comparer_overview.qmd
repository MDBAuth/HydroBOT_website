...
-   Quantitative outcome values on y
    ...
    -   [Timeseries](timeseries.qmd)
        ...
        -   [outcomes](timeseries.qmd)

-   Quantitative outcome values as colour
...
Finally, we provide an example using these approaches to [compare aggregation choices](comparing_aggregations.qmd).
